...
namespace Prototipo2P
{
	...
	{
		string usuario = "";
		public Clientes(string usuarioActivo)
		{
			InitializeComponent();
			usuario = usuarioActivo;
			string[] alias = { "Codigo", "Nombres", "Direccion","Nit", "Telefono", "Estado" }; // Arreglo de nombres para campos
			...
			navegador1.asignarNombreForm("Registro de Clientes"); // Titulo y nombre del form
		}
